# genai_hackathon/run_candidate_ablation_hardstress_suite.py
...
OUT = "genai_hackathon/candidate_ablation_hardstress_suite_out"
...
def make_overspeed_stress():
    ...
    # Stronger actuator / environment stress
...
def main():
    ...
    print("\n=== Candidate Ablation Hard-Stress Suite ===")
    print(
